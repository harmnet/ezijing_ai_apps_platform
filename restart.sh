...
# 设置百度云BOS环境变量
export BAIDU_BCE_ACCESS_KEY_ID="0b82aabeebabdfeaaabe0bde"
export BAIDU_BCE_SECRET_ACCESS_KEY="ff82d82ab4894f27aae79ab297e03e79"
...
if [ "$1" = "help" ]; then
  ...
  echo -e "${YELLOW}======= 仅启动前端服务 =======${NC}"
  
  # 停止前端服务
  echo -e "${YELLOW}[1/2] 停止前端服务...${NC}"
  free_frontend_port
