        ...
        <div v-if="currentStep === 5" class="step-content-panel">
          ...
          <div class="task-result-container">
            ...
            <div class="task-status-card">
              ...
              <!-- 处理中状态显示 -->
              <div v-if="taskStatus?.status === 'PROCESSING' || taskStatus?.status === 'GENERATING'" class="processing-section">
  ...
  setup() {
    ...
    const downloadVideo = () => {
      if (taskStatus.value && taskStatus.value.videoUrl) {
        ...
        link.download = `数字人视频_${new Date().getTime()}.mp4`;
